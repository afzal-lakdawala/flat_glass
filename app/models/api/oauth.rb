class Api::Oauth < ActiveRecord::Base
  
  #GEMS USED
  self.table_name = :api_oauths
  
  #ACCESSORS
  attr_accessible :user_id, :app, :created_by, :refresh_token, :token, :token_expires_at, :updated_by, :name, :email
  
  #ASSOCIATIONS
  has_many :api_accounts, class_name: "Api::Account", dependent: :destroy, foreign_key: "api_oauth_id"
